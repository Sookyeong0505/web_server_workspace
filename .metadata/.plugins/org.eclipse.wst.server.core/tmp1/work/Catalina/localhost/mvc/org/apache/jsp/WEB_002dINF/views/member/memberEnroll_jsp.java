 ...
 * Generated at: 2023-06-22 06:57:29 UTC
...
public final class memberEnroll_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/common/header.jsp", Long.valueOf(1687404430245L));
    _jspx_dependants.put("/WEB-INF/views/common/footer.jsp", Long.valueOf(1687311703571L));
  }
  ...
  static {
    ...
    _jspx_imports_classes.add("com.sh.mvc.member.model.vo.Member");
  }
 ...
 if(loginMember ==null){
      ...
      out.write("      // 아이디\r\n");
      out.write("       const memberId = e.target.memberId;\r\n");
      out.write("      if(!/^\\w{4,}$/.test(memberId.value)){\r\n");
      ...
      out.write("      \r\n");
      out.write("      // 비밀번호\r\n");
      out.write("      const password = e.target.password;\r\n");
      out.write("      if(!/^.{4,}$/.test(password.value)){\r\n");
      out.write("         alert(\"비밀번호를 4글자 이상 입력하세요.\");\r\n");
      out.write("         e.preventDefault();\r\n");
      out.write("         return;\r\n");
      out.write("      }\r\n");
      out.write("   }\r\n");
 ...
 if(loginMember == null){ 
      ...
      out.write("                      name=\"loginFrm\" \r\n");
      out.write("                      action=\"");
      out.print( request.getContextPath() );
      out.write("/member/login\"\r\n");
      out.write("                         method=\"post\">\r\n");
      out.write("                         \r\n");
      out.write("                         <!--request.getContextPath()는 /mvc-->\r\n");
      out.write("                    <table>\r\n");
      out.write("                        <tr>\r\n");
      out.write("                            <td>\r\n");
      out.write("                            <input type=\"text\" name=\"memberId\" id=\"memberId\" placeholder=\"아이디\" \r\n");
      out.write("                            value=\"");
      ...
      out.write("				<td>\r\n");
      out.write("					<input type=\"text\" placeholder=\"4글자이상\" name=\"memberId\" id=\"_memberId\" required>\r\n");
      out.write("				</td>\r\n");
      out.write("			</tr>\r\n");
      out.write("			<tr>\r\n");
      out.write("				<th>패스워드<sup>*</sup></th>\r\n");
      out.write("				<td>\r\n");
      out.write("					<input type=\"password\" name=\"password\" id=\"_password\" required><br>\r\n");
      out.write("				</td>\r\n");
      out.write("			</tr>\r\n");
      out.write("			<tr>\r\n");
      ...
      out.write("<script>\r\n");
      out.write("// 비밀번호 일치여부\r\n");
      out.write("document.querySelector(\"#passwordConfirmation\").onblur = (e) => {\r\n");
      out.write("	const pw1 = document.querySelector(\"#_password\");\r\n");
      out.write("	const pw2 = e.target;\r\n");
      out.write("	\r\n");
      out.write("	if(pw1.value !== pw2.value) {\r\n");
      out.write("		alert(\"비밀번호가 일치하지 않습니다.\");\r\n");
      out.write("		pw1.select();\r\n");
      out.write("	}\r\n");
      out.write("};\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("//폼 유효성 검사\r\n");
      out.write("document.memberEnrollFrm.onsubmit = (e) => {\r\n");
      out.write("   const frm = e.target;\r\n");
      out.write("   const memberId = e.target.memberId;\r\n");
      out.write("   const password = e.target.passowrd;\r\n");
      out.write("   // passwordConfirmation 는 name값이 없으므로 querySelector를 통해 검사한다.\r\n");
      out.write("   const passwordConfirmation = e.target.querySelector(\"#passwordConfirmation\");\r\n");
      out.write("   const name = e.target.name;\r\n");
      out.write("   const phone = e.target.phone;\r\n");
      out.write("   \r\n");
      out.write("   // 아이디 검사 - 영문자/숫자 4글자 이상\r\n");
      out.write("   if (!/^\\w{4,}$/.test(memberId.value)) {\r\n");
      out.write("      alert(\"아이디는 영문자/숫자 4글자 이상이어야 합니다.\");\r\n");
      out.write("      return false;\r\n");
      out.write("   }\r\n");
      out.write("   \r\n");
      out.write("   // 비밀번호 검사 - 영문자/숫자/특수문자!@#$% 4글자 이상\r\n");
      out.write("   if (!/^[\\w!@#$%]{4,}$/.test(password.value)) {\r\n");
      out.write("      alert(\"비밀번호는 영문자/숫자/특수문자 !@#$% 4글자 이상이어야 합니다.\");\r\n");
      out.write("      return false;\r\n");
      out.write("   }\r\n");
      out.write("   \r\n");
      out.write("   if (password.value !== passwordConfirmation.value) {\r\n");
      out.write("      alert(\"두 비밀번호가 일치하지 않습니다.\");\r\n");
      out.write("      return false; \r\n");
      out.write("   }\r\n");
      out.write("   \r\n");
      out.write("   \r\n");
      out.write("   // 이름 검사 - 한글 2글자 이상\r\n");
      out.write("   if (!/^$/.test(name.value)) {\r\n");
      out.write("      alert(\"이름은 한글 2글자 이상이어야 합니다.\");\r\n");
      out.write("      return false;\r\n");
      out.write("   }\r\n");
      out.write("   \r\n");
      out.write("   // 전화번호 검사 - 01012345678 010으로 시작하고 숫자 8자리 여부확인\r\n");
      out.write("   if (!/^010\\d{8}$/.test(phone.value)) {\r\n");
      out.write("      alert(\"전화번호는 010으로 시작하고 숫자 8자리이어야 합니다.\");\r\n");
      out.write("      return false;\r\n");
      out.write("   }\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("		<footer>\r\n");
      out.write("			<p>&lt;Copyright 1998-2023 <strong>KH정보교육원</strong>. All rights reserved.&gt;</p>\r\n");
      out.write("		</footer>\r\n");
      out.write("	</div>\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
